const animals = [
  {
    ...
    cams: [
      ...
      { img: '../../assets/images/lemur-additional-cam-card-3.jpg', label: 'CAM 3' },
    ],
    ...
    photo: '../../assets/images/rectangle-madagascarian-lemur.jpg',
  ...
  },
  {
    ...
    cams: [
      ...
      { img: '../../assets/images/gorilla-additional-cam-card-3.jpg', label: 'CAM 3' },
    ],
    ...
    photo: '../../assets/images/rectangle-gorilla-in-congo.jpg',
  ...
  },
  {
    ...
    photo: '../../assets/images/rectangle-west-end-bald-eagles.jpg',
  ...
  },
  {
    ...
    photo: '../../assets/images/rectangle-giant-panda.jpg',
...
function renderContent() {
  ...
  document.getElementById('donationTitle').textContent = animal.donationTitle;
  document.getElementById('donationText').textContent = animal.donationText;
  document.getElementById('factText').textContent = animal.fact;

  const infoTable = document.getElementById('infoTable');
  infoTable.innerHTML = '';
  Object.entries(animal.info).forEach(([key, value]) => {
    const tr = document.createElement('tr');
    if (key === 'Range:') {
      tr.innerHTML = `<td>${key}</td><td>${value} <a class="zoos-info__map-link" href="../map/">View Map</a></td>`;
    } else {
  ...
  infoPhoto.src = animal.photo;
  infoPhoto.alt = animal.title;
